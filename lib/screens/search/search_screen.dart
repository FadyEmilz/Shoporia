...
import 'package:shophoria/screens/search/widgets/product_single.dart';
                  ...
                  Expanded(
                    child: DynamicHeightGridView(builder: (context,index){
                      return Center(child: ChangeNotifierProvider.value(value:searchCTRL.text.isEmpty? listProCaT[index] : listSearch[index],
                          child: ProductSingle(productId:searchCTRL.text.isEmpty? listProCaT[index].productID : listSearch[index].productID,)));
